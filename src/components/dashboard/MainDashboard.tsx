...
import { Plus, Filter, TrendingUp, Clock, CheckCircle, XCircle, Eye, Edit, Trash2 } from 'lucide-react';
          ...
          <div className="flex flex-col sm:flex-row gap-4 flex-1">
            <div className="relative">
              <input
                ...
                className="w-full md:w-80 pl-4 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
